...
namespace MAUIsland;
public partial class AutoCompleteTextFieldPageViewModel : SingleControlEditingViewModel<AutoCompleteTextField>
{
    ...
    public AutoCompleteTextFieldPageViewModel(IAppNavigator appNavigator, IDialogService dialogService) : base(appNavigator)
    {
